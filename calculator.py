...
class calculator:
    def __init__(self,master):
        master.title("Calculator") # this is used for giving the title
        master.geometry('357x420+0+0') # this  is used for measuring the length and the breadth of the calculator 
        master.config(bg = 'gray') # bg means background color 
...
root=Tk()# It used for creating a new window object
